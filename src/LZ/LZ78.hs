...
-- | LZ78 uncompressLZ78 method
-- uncompressLZ78 :: [(Int, Char)] -> String
-- uncompressLZ78 = concatMap decode
--   where
--     decode :: (Int, Char) -> String
--     decode (0, c) = [c]
--     decode (index, nextChar) = replicate index (last dict) ++ [nextChar]
--       where
--         dict = decode (index - 1, nextChar)
